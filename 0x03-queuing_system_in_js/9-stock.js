...
const getAsync = promisify(clinet.get).bind(client);
...
app.get('/list_products/:itemId', async (req, res) => {
    ...
    if (!currentStock) {
	await reserveStockById(itemId, item.initialAvailbleQuantity);
	item.currentQuantity = item.initialAvailableQunatity;
...
app.get('reserve_product/:itemId', async (req, res) => {
    ...
    let currentStock = await getCurrentResrvedStockById(itemId);
